        ...
        while q:
            ...
            if cur.lower_bound < self.sol:
                if len(cur.path) < n - 1:
                    ...
                    cur_dist = self.get_cur_distance(cur.path) + self.matrix[cur.path[0]][cur.path[-1]]
